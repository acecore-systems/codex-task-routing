...
def check():
    ...
    for name in ['LICENSE', 'scripts/routing.py', 'scripts/prelaunch.py', 'scripts/launcher_bootstrap.py', 'scripts/launcher_entry.py', 'scripts/install_launcher.py', 'hooks/hooks.json', 'defaults/config.json', 'skills/task-routing/SKILL.md', 'skills/task-routing/references/configuration.md']:
